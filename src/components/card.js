  ...
  return (
    <div className="card" style={{ margin: "2em 0" }}>
      ...
      <footer className="card-footer has-background-warning">
        <a target="_blank" href={props.link} className="card-footer-item">
          Github
        </a>
        {props.frontend ? (
          <a target="_blank" href={props.frontend} className="card-footer-item">
            Frontend
          </a>
        ) : null}
        {props.backend ? (
          <a target="_blank" href={props.backend} className="card-footer-item">
            Backend
          </a>
        ) : null}
      </footer>
